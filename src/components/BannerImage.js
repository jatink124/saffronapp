...
const linkStyle = {
  position: 'absolute',
  top: '50%', // Adjust the positioning based on your specific needs
  left: '50%', // Adjust the positioning based on your specific needs
  transform: 'translate(-50%, -50%)',
  width: '80%', // Adjust the size of the transparent link
  height: '3rem', // Adjust the size of the transparent link
  cursor: 'pointer',
